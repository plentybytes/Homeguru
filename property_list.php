...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php
    ...
    $strProperty="SELECT * FROM property where user_id='".$_SESSION['user']['id']."' and property_status!='Block' and property_change_status='Unsold'  ORDER BY property_id DESC";
  ...
  <tr>
    ...
    <td align="center"><?php echo  $today = date('F j, Y', strtotime($rsProperty["property_created_date"]));?></td>
	...
	<a href="property_list.php?source=<?php echo base64_encode($rsProperty["property_id"]); ?>&action=rent" title="Rented" onclick="if(!confirm('You Rented to this Property.')) return false;">[Rentable]</a><?php } }?>
&nbsp; <input type="checkbox" name="pid[]" value="<?=$rsProperty["property_id"];?>">
</td>
  </tr>
  <?php }}else{ ?>
    <tr>
  ...
  <tfoot>
   <tr>
    <td  colspan="6">&nbsp; <input name="" class="submit" value="delete selected" type="submit"></td>
