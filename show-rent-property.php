...
include('includes/application.php');
	...
	$strProperty="SELECT  * FROM property where city_id='".base64_decode($_GET["source"])."' and property_status='Active' and property_transaction_type='rent' and property_change_status='Rentable'";
...
<div id="middle">
  ...
  <div id="left-panel">
    <h1>Property for Rent in <strong><?php echo showLocality(base64_decode($_GET["source"]))?></strong> </h1>

    <div id="sale">
<div class="view">
<ul>
<li><a class="select" href="#"><span>List view</span></a></li>
<li><a href="map-view.php?en=<?php echo base64_encode(getPropertyID($strProperty));?>"><span>Map view</span></a></li>
</ul>
<div class="clear"></div>
</div>
<div class="clear">&nbsp;</div>
