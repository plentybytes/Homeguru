...
<?php
$strProperty=dbQuery("SELECT property_total_price,city_id,property_id,state_id, count( state_id ) AS cnt FROM property where property_status='Active' and property_transaction_type='sell' GROUP BY state_id  ORDER BY cnt DESC LIMIT 0 ,8");
