...
myflowers.init()
    ...
    <div id="right-panel">
        ...
        <button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-envelope"></span> Email a friend</button>
        <button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-list-alt"></span> Report listing content</button>
        <button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-ban-circle"></span> Hide property</button>
        <button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-file"></span> Add a note</button>
        ...
        <div class="well">
            <div>
                ...
                <div>
                    <ul>
                        <li> <span class="glyphicon glyphicon-transfer" style="color: #CA3C38;"></span>Southall(0.8 miles) </li>
