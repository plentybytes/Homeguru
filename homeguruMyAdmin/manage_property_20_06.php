...
<?php $i++; } ?>
	...
	include("action/step_two_property.php");
      ...
      <h2>View Prpperty Details </h2>
          ...
          <tbody scope="col">
       <tr> <td colspan="2" class="rounded-company"><strong>Posted By :</strong> <span style="float:right;"><a  target="_blank" href="<?php echo hrefLink(APP_ADMIN_DIR."manage_user.php", "action=view&userid=".$userInfo["user_id"]);?>"  class="bt_green"><span class="bt_green_lft"></span><strong>Edit Property </strong><span class="bt_green_r"></span></a></span><?php if($pageInfo["property_owner_type"]!='Admin'){?><span style="float:right;"><a  target="_blank" href="<?php echo hrefLink(APP_ADMIN_DIR."manage_user.php", "action=view&userid=".$userInfo["user_id"]);?>"  class="bt_green"><span class="bt_green_lft"></span><strong>User Info. </strong><span class="bt_green_r"></span></a></span> <?php }else{ echo " ADMIN" ; }?></td>
