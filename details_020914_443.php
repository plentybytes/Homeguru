...
myflowers.init()
    ...
    <div id="right-panel">
        <div class="well clearfix">
            ...
            <img src="images/user_images/<?php echo $resultProperty1['user_image']?>" class="img-responsive" width="100" height="69" alt="img" />
            ...
            <h4>Call <?php echo $resultProperty1['user_mobile_number']?></h4>
