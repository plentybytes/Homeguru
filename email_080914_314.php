...
<li><a href="http://homesguru.co.uk/property-agent.php"> UK estate agents</a></li>
   ...
   <div class="inner_2"><h1>Email a friend about the <?php echo $resultProperty["property_bedrooms"];?> bedroom semi-detached house for sale at <?php echo $resultProperty["property_address"];?> </h1>
     ...
     <div class="inner">
        ...
        <div class="inner_form">
        	...
        	<div class="sendemail" style="background:none"><input type="submit" name="button" id="button" value="Send Email" style="margin-left:170px;"/><a href="#">Send Email</a></div>
        </div>
     </form>
     </div>
...
<p></p><p>
	Search for UK estate agents Search for property for sale House prices 
