...
$.ajax({url: '/ajax.php?query='+query,dataType: 'json', type: 'GET',success: (function(data){
if(data==0)
{
...
<div id="addr1"><label>Address:</label><span id="addr_manual"><select name="addr" class="select" id="addr"><option>Select</option></select></span><br /></div>
