    ...
    <div id="right-panel">
        ...
        <div class="well">
            <div>
                ...
                <div>
                    <ul>
                       <?php foreach($nearByTrainStation as $tkey=>$tval){
                        if(strpos($tval,'Underground') == true ){?>
                        <li><span class="custom_glyphicon1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><?php echo $tval?> </li>
                        <?}else{?>
                        <li><span class="custom_glyphicon2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><?php echo $tval?> </li>
