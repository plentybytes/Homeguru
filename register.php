...
<label style="margin-left:-245px;"><input type="checkbox" name="check" value="Yes" /></label> 
<span class="check">I do not wish to receive information from HomesGuru or selected partners. </span>
<div class="clear"></div>
<label>&nbsp;</label> <input type="submit" name="" class="submit" value="Register" />
<div class="clear"></div>
</div></form>
<span><p>If you have any enquiry, feel free to contact us !!</p></span>
