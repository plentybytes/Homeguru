...
if($pageviewcounterstatusrows==0){
  $pageviewarray=array('property_id'=>$addtonote_property_id,'IP'=>$_SERVER['REMOTE_ADDR']);
...
<div class="clear"></div>    
    ...
    <div style="width:645px; height:auto;">
    <div style="width:200px; height:auto; float:left;">asdf</div>
    <div style="width:200px; height:auto; float:left;">asdf</div>
    <div style="width:200px; height:auto; float:left;">asdf</div>
...
foreach ($data['results'] as $key=>$value) {
    ...
    <ul class="box124">
      <?php if($tot_school_count<=3){?>  
        ...
        <li class="box123">
                <span class="interface nearby_stations_schools_uk_primary_school"></span>
            <span class="nearby_stations_schools_name"><?php echo $value['name']."(".$distance_in_miles." miles)"?></span>
   ...
   <ul class="box124">
        ...
        <li class="box123">
                <span class="interface nearby_stations_schools_uk_secondary_school"></span>
            <span class="nearby_stations_schools_name"><?php echo $value['name']."(".$distance_in_miles." miles)"?></span>
  ...
  <ul class="box124">
       ...
       <li class="box123">
                <span class="interface nearby_stations_schools_uk_primary_and_secondary_school"></span>
            <span class="nearby_stations_schools_name"><?php echo $value['name']."(".$distance_in_miles." miles)"?></span>
...
<div id="local-info-la-stats" class="tabs ui-tabs ui-tabs-widget ui-widget ui-widget-content ui-corner-all">
    ...
    <div data-highcharts-chart="1" aria-hidden="false" aria-expanded="true" role="tabpanel" aria-labelledby="ui-id-10" id="local-authority-stats-demographic" class="ui-tabs-panel ui-widget-content ui-corner-bottom"><div style="position: relative; overflow: hidden; width: 583px; height: 300px; text-align: left; line-height: normal; z-index: 0; font-family: sans-serif; font-size: 12px; left: 0px; top: 0.516602px;" id="highcharts-2" class="highcharts-container"><svg height="300" width="583" xmlns="http://www.w3.org/2000/svg" style="font-family:sans-serif;font-size:12px;" version="1.1"><desc>Created with Highcharts 4.0.0</desc><defs><clipPath id="highcharts-3"><rect height="174" width="469" y="0" x="0"></rect></clipPath></defs><rect class=" highcharts-background" fill="rgba(255, 255, 255, 0)" strokeWidth="0" height="300" width="583" y="0" x="0"></rect><g zIndex="1" class="highcharts-grid"></g><g zIndex="1" class="highcharts-grid"><path opacity="1" zIndex="1" stroke-dasharray="NaN" stroke-width="1" stroke="#dedede" d="M 84 47.5 L 553 47.5" fill="none"></path><path opacity="1" zIndex="1" stroke-dasharray="NaN" stroke-width="1" stroke="#dedede" d="M 84 106.5 L 553 106.5" fill="none"></path><path opacity="1" zIndex="1" stroke-dasharray="NaN" stroke-width="1" stroke="#dedede" d="M 84 164.5 L 553 164.5" fill="none"></path><path opacity="1" zIndex="1" stroke-dasharray="NaN" stroke-width="1" stroke="#dedede" d="M 84 222.5 L 553 222.5" fill="none"></path></g><g zIndex="2" class="highcharts-axis"><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 217.5 222 L 217.5 232" fill="none"></path><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 284.5 222 L 284.5 232" fill="none"></path><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 351.5 222 L 351.5 232" fill="none"></path><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 418.5 222 L 418.5 232" fill="none"></path><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 485.5 222 L 485.5 232" fill="none"></path><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 553.5 222 L 553.5 232" fill="none"></path><path opacity="1" stroke-width="1" stroke="#C0D0E0" d="M 150.5 222 L 150.5 232" fill="none"></path><path opacity="undefined" stroke-width="1" stroke="#C0D0E0" d="M 83.5 222 L 83.5 232" fill="none"></path><path visibility="visible" zIndex="7" stroke-width="1" stroke="#dedede" d="M 84 222.5 L 553 222.5" fill="none"></path></g><g zIndex="2" class="highcharts-axis"><text y="135" visibility="visible" style="color:#999999;fill:#999999;" class=" highcharts-yaxis-title" transform="translate(0,0) rotate(270 44 135)" text-anchor="middle" zIndex="7" x="44">%</text></g><g zIndex="3" class="highcharts-series-group"><g clip-path="url(#highcharts-3)" style="" transform="translate(84,48) scale(1 1)" zIndex="0.1" visibility="visible" class="highcharts-series highcharts-tracker"><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="112" width="17" y="62.5" x="14.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="75" width="17" y="99.5" x="81.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="129" width="17" y="45.5" x="148.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="97" width="17" y="77.5" x="215.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="71" width="17" y="103.5" x="282.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="45" width="17" y="129.5" x="349.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#d64521" stroke="#FFFFFF" height="51" width="17" y="123.5" x="416.5"></rect></g><g clip-path="none" transform="translate(84,48) scale(1 1)" zIndex="0.1" visibility="visible" class="highcharts-markers"></g><g clip-path="url(#highcharts-3)" style="" transform="translate(84,48) scale(1 1)" zIndex="0.1" visibility="visible" class="highcharts-series highcharts-tracker"><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="102" width="17" y="72.5" x="35.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="76" width="17" y="98.5" x="102.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="78" width="17" y="96.5" x="169.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="81" width="17" y="93.5" x="236.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="80" width="17" y="94.5" x="303.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="68" width="17" y="106.5" x="370.5"></rect><rect stroke-width="1" ry="0" rx="0" fill="#b2d235" stroke="#FFFFFF" height="95" width="17" y="79.5" x="437.5"></rect></g><g clip-path="none" transform="translate(84,48) scale(1 1)" zIndex="0.1" visibility="visible" class="highcharts-markers"></g></g><text y="35" style="color:#999999;font-size:11px;fill:#999999;width:479px;" zIndex="4" class="highcharts-title" text-anchor="middle" x="292"><tspan>Population breakdown in Haringey (2012)</tspan></text><g transform="translate(122,263)" zIndex="7" class="highcharts-legend"><g zIndex="1"><g><g transform="translate(8,3)" zIndex="1" class="highcharts-legend-item"><text zIndex="2" text-anchor="start" style="color:#333333;font-size:12px;font-weight:bold;cursor:pointer;fill:#333333;" y="15" x="21">Haringey</text><rect fill="#d64521" zIndex="3" height="12" width="16" y="4" x="0"></rect></g><g transform="translate(102,3)" zIndex="1" class="highcharts-legend-item"><text zIndex="2" text-anchor="start" style="color:#333333;font-size:12px;font-weight:bold;cursor:pointer;fill:#333333;" y="15" x="21"><tspan>National average (England and Wales)</tspan></text><rect fill="#b2d235" zIndex="3" height="12" width="16" y="4" x="0"></rect></g></g></g></g><g zIndex="7" class="highcharts-axis-labels highcharts-xaxis-labels"><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="117.5">0-14</text><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="184.5">15-24</text><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="251.5">25-34</text><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="318.5">35-44</text><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="385.5">45-54</text><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="452.5">55-64</text><text opacity="1" y="242" style="width:47px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="middle" x="519.5">65+</text></g><g zIndex="7" class="highcharts-axis-labels highcharts-yaxis-labels"><text opacity="1" y="227.5" style="width:172px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="end" x="69">0</text><text opacity="1" y="169.5" style="width:172px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="end" x="69">10</text><text opacity="1" y="111.5" style="width:172px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="end" x="69">20</text><text opacity="1" y="53.5" style="width:172px;color:#606060;cursor:default;font-size:11px;fill:#606060;" text-anchor="end" x="69">30</text></g><g transform="translate(0,-9999)" style="cursor:default;padding:0;white-space:nowrap;" zIndex="8" class="highcharts-tooltip"><path stroke-width="1" d="M 3 0 L 13 0 C 16 0 16 0 16 3 L 16 13 C 16 16 16 16 13 16 L 3 16 C 0 16 0 16 0 13 L 0 3 C 0 0 0 0 3 0" fill="#eee"></path><text y="21" style="font-size:12px;color:#000;fill:#000;" zIndex="1" x="8"></text></g><text y="295" style="cursor:pointer;color:#cccccc;font-size:9px;fill:#cccccc;" zIndex="8" text-anchor="end" x="573"><tspan>Source: UK Census Data</tspan></text></svg></div></div><div aria-hidden="true" aria-expanded="false" style="display: none;" role="tabpanel" aria-labelledby="ui-id-11" aria-live="polite" class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="ui-tabs-6"></div><div aria-hidden="true" aria-expanded="false" style="display: none;" role="tabpanel" aria-labelledby="ui-id-12" aria-live="polite" class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="ui-tabs-7"></div><div aria-hidden="true" aria-expanded="false" style="display: none;" role="tabpanel" aria-labelledby="ui-id-13" aria-live="polite" class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="ui-tabs-8"></div>
</div>              
...
<div id="local-info-neighbours" class="tabs ui-tabs ui-tabs-widget ui-widget ui-widget-content ui-corner-all">
    ...
    <ul role="tablist" class="clearfix ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
        <li aria-selected="true" aria-labelledby="ui-id-14" aria-controls="neighbours-info-housing" tabindex="0" role="tab" class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a id="ui-id-14" tabindex="-1" role="presentation" data-ga-category="Local info - Neighbours" data-ga-action="Housing" data-ga-label="/tracking/for-sale/details/" class="ui-tabs-active ui-tabs-anchor" href="#neighbours-info-housing" data-category="housing"><span>Housing</span></a></li>
...
myflowers.init()
    ...
    <div id="right-panel">
        ...
        <input type="submit" id="savetofavorites" name="savetofavorites" value="Save to favourites" class="btn btn-default btn-block"><span class="glyphicon glyphicon-star"></span> Save to favourites
        </form>
