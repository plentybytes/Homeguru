...
myflowers.init()
    ...
    <div id="right-panel">
        ...
        <div id="addnote"><button id="addnotebutton" type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-file"></span> Add a note</button></div>
				 ...
				 ?>
					...
					<?php }else{?>
					 ...
					 <?php while($property_rows=dbFetchArray($tot_property_num)){?>
					   ...
					   <div class="editDeleteTex"><?php echo $property_rows['property_note'];?></div>  
