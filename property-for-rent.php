...
<div id="middle">
  <div class="main">
    ...
    <div id="left-panel">
      ...
      <?php
	$strProperty=dbQuery("SELECT property_total_price,city_id,property_id,state_id, count( state_id ) AS cnt FROM property where property_status='Active' and property_transaction_type='rent'  and property_change_status='Rentable' GROUP BY state_id  ORDER BY cnt DESC LIMIT 0 ,8");
 ...
 ?>
      ...
      <div class="categoryitems">
        <?php 
	$strPropertyCity=dbQuery("SELECT  city_id,property_id,count(property_id) AS cityCount FROM property where  property_status='Active' and property_transaction_type='rent'  and property_change_status='Rentable' and state_id='".$rsProperty["state_id"]."' GROUP BY city_id  ORDER BY cityCount DESC LIMIT 0 , 5");
