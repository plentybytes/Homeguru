...
include('includes/application.php');
   ...
   $proid=base64_decode($_GET['proid']);
    ...
    $property_mobile_number=$resultProperty['property_mobile_number'];
...
if($addeditpropertynum==0){     
 ...
 if(!empty($_POST['txtproperty'])){ 
  ...
  echo "<script>
  document.getElementById('msgbox').innerHTML = 'Please filled up the comment';
</script>";
...
<div id="middle">
  ...
  <div id="left-panel">
    <h1 style="font-weight: bold;color: #000000;padding-bottom: 2px;font-size: 22px;"><?php echo $resultProperty["property_bedrooms"];?> bedroom semi-detached house for sale</h1>
      <p style="font-size: 14px;margin-bottom: 15px;"><?php echo $resultProperty["property_address"];?><!--,-->,<?php echo substr($resultProperty["property_postal_code"], 0, 3);?></p>
...
<div class="clear"></div>
    <div class="bottom-plus-half">
        ...
        <div class="top" itemprop="description">
            ...
            <p style="text-align: justify;"><?php echo htmlspecialchars_decode($resultProperty['property_description']);?></p>
...
<!-- code commented removed by akash-->
...
<?php include('includes/popup.html');?>
    ...
    <div id="right-panel">
        <div class="well clearfix">
            ...
            <img src="images/user_images/<?php echo $resultProperty1['logo']?>" class="img-responsive" width="100" height="69" alt="img" />
            ...
            <h4>Call <?php echo $property_mobile_number; ?></h4>
