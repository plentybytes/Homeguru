...
<div class="list_part">
	...
	<div class="list_part_box">
		<div class="list_part_box_left"><input id="<?php echo $resultProperty['property_id']?>" name="option2[]" type="checkbox" value="<?php echo $resultProperty['property_id']?>" class="second" /> <span><img src="images/home_image.png" width="93" height="66" alt="img" /></span></div>
			...
			<div class="list_part_box_right"><img src="images/<?php echo $resultLogoProperty['logo']?>" width="100" height="69" alt="img" /></div>
			<?php }?>
		</div>
