...
$sentMessage="Name:".$name."<br>";
$sentMessage.="Email:".$email."<br>";
$sentMessage.="Message:".$message."<br>";
...
//
        ...
        {*/
           ...
           // $message= "Please click the link below to activate your candidate account http://".$_SERVER['HTTP_HOST']."/job.php?active=$stud_name";
			...
			$send_mail=mail($to,$subject,$sentMessage,$headers);
