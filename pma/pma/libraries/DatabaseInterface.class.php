...
class PMA_DatabaseInterface
{
    ...
    /**
     * converts charset of a mysql message, usually coming from mysqli_error(),
    ...
    public function getDatabasesFull($database = null, $force_stats = false,
        ...
        $mysqli_error = $this->getError($link);
        if (! count($databases) && $GLOBALS['errno']) {
            PMA_Util::mysqlDie($mysqli_error, $sql);
        }
